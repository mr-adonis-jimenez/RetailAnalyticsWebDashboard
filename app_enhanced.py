...
def create_app(config_name: Optional[str] = None) -> Flask:
    ...
    mode = config_name or 'default'
    logger.info(f"Starting {app_name} in {mode} mode")
...
def _seed_sample_data() -> None:
    ...
    products = [
        Product(
            ...
            category_id=1, price=79.99,
            cost=40.00, stock_quantity=50),
        Product(
            sku='ELEC-002', name='Smart Watch',
            category_id=1, price=199.99,
            cost=100.00, stock_quantity=30),
        Product(
            sku='CLOTH-001', name='Cotton T-Shirt',
            category_id=2, price=19.99,
            cost=8.00, stock_quantity=100),
        Product(
            sku='CLOTH-002', name='Jeans',
            category_id=2, price=49.99,
            cost=25.00, stock_quantity=75),
        Product(
            sku='HOME-001', name='Coffee Maker',
            category_id=3, price=89.99,
            cost=45.00, stock_quantity=40),
        Product(
            sku='SPORT-001', name='Yoga Mat',
            category_id=4, price=29.99,
            cost=15.00, stock_quantity=60),
        Product(
            sku='BOOK-001',
            name='Python Programming Guide',
            category_id=5, price=39.99,
            cost=20.00, stock_quantity=80),
    ]
    ...
    customers = [
        Customer(
            ...
            city='Miami', state='FL',
            country='USA', customer_segment='VIP'),
        Customer(
            email='jane.smith@example.com',
            first_name='Jane', last_name='Smith',
            city='Fort Lauderdale', state='FL',
            country='USA', customer_segment='Regular'),
        Customer(
            email='bob.jones@example.com',
            first_name='Bob', last_name='Jones',
            city='Pompano Beach', state='FL',
            country='USA', customer_segment='New'),
    ]
